                                                ...
                                                <tr key={campaign.id} className="hover:bg-gray-50 transition-colors group">
                                                    ...
                                                    <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                                        <div className="flex justify-end items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                            ...
                                                            <form action={`/dashboard/ads/${campaign.id}/delete`} method="POST" className="inline">
                                                                <button type="submit" className="inline-flex items-center justify-center p-2 text-red-500 hover:text-red-700 transition-colors rounded-md hover:bg-red-50 bg-white ring-1 ring-inset ring-red-300" title="Delete Campaign">
